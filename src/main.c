...
static GeglColor *default_pres_col = NULL;

static GeglColor *default_disc_col = NULL;

static GeglColor *default_rigmask_col = NULL;

static GeglColor *default_gray_col = NULL;
